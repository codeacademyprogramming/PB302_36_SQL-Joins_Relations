...
SELECT *, 
(SELECT COUNT(*) FROM Employees AS E WHERE E.DepartmentId=D.Id) AS EmployeeCount
FROM Departments AS D

SELECT * FROM Departments AS D
WHERE (SELECT COUNT(*) FROM Employees AS E WHERE E.DepartmentId=D.Id)>0

SELECT * FROM Departments AS D
WHERE NOT EXISTS (SELECT * FROM Employees AS E WHERE E.DepartmentId=D.Id)

SELECT AVG(SALARY) FROM Employees WHERE DepartmentId=1

SELECT ID,NAME, (SELECT AVG(SALARY) FROM Employees WHERE DepartmentId=D.Id) FROM Departments AS D
...
WHERE NOT EXISTS (SELECT * FROM EmployeeProjects AS EP WHERE EP.EmployeeId=E.Id)
